#!/bin/bash
# Make sure to give yourself permission to launch this script with 'chmod u+x launch_ggxrd_freecam_injector_linux.sh' command.
# Then cd into the same directory as this script and launch it using './launch_ggxrd_freecam_injector_linux.sh' or 'bash launch_ggxrd_freecam_injector_linux.sh'.
...
TOOLNAME64="${1-ggxrd_freecam_injector64bit.exe}"  # ${VARNAME-DEFAULTVALUE} substitutes DEFAULTVALUE in case the variable is empty
TOOLNAME32="${1-ggxrd_freecam_injector.exe}"
